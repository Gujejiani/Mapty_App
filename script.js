...
class App {
  ...
  _loadMap(pos) {
    ...
    this.#map = L.map('map').setView(coords, this.#mapZoopLevel);
  ...
  _newWorkout(e) {
    ...
    // if workout cicling, create cycling object
    if (type === 'cycling') {
    ...
    //Hide a form+ clear inout fealds + clear inputs
    this._hideForm();
    //set local storage all workouts
  ...
  _renderWorkout(workout) {
    ...
    if (workout.type === 'cycling') {
      ...
      <div class="workout__details">
        <span class="workout__icon">⛰</span>
        <span class="workout__value">${workout.elevationGame}</span>
  ...
  _moveToPopup(e) {
    ...
    this.#map.setView(workout.coords, this.#mapZoopLevel, {
      animate: true,
      pan: {
        duration: 1,
      },
